...
require 'scripts/eye_spot/php/password.php';
if (!$auth) {
...
require 'scripts/eye_spot/php/auth.php';
require_once 'scripts/eye_spot/php/FTL.php';
require_once 'scripts/eye_spot/php/func.php';
require 'scripts/eye_spot/php/theme.php';
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="img/logo.svg" alt="eye_spot Logo" style="border: 0" width="90" height="90">
                                <p>
                                   Team PVS
                                </p>
                            </li>
...
<?php require 'scripts/eye_spot/php/sidebar.php'; ?>
