...
require 'scripts/eye_spot/php/header.php';
?>
    ...
    <section style="padding: 15px;">
        <div class="login-logo">
            <div class="text-center">
                <img src="img/logo.svg" alt="EYE_SPOT logo" class="loginpage-logo">
            </div>
...
<script src="scripts/eye_spot/js/footer.js?v=<?php echo $cacheVer; ?>"></script>
</body>
</html>
