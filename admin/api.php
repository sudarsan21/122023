...
$api = true;
require_once 'scripts/eye_spot/php/password.php';
require_once 'scripts/eye_spot/php/FTL.php';
require_once 'scripts/eye_spot/php/database.php';
require_once 'scripts/eye_spot/php/auth.php';
check_cors();
...
if (isset($_GET['enable']) && $auth) {
    ...
    // Determine if updates are available for eye_spot
    ...
    require 'scripts/eye_spot/php/update_checker.php';
    ...
    if (isset($_GET['add'])) {
        ...
        require 'scripts/eye_spot/php/groups.php';
