...
require 'scripts/eye_spot/php/savesettings.php';
require_once 'scripts/eye_spot/php/FTL.php';

// Reread ini file as things might have been changed
// DEFAULT_FTLCONFFILE is set in "scripts/eye_spot/php/FTL.php";
...
if ($FTLpid !== 0) {
    ...
    echo ' '.$timezone; ?></td>
                                            ...
                                            See also our <a href="" rel="noopener" target="_blank">DNS cache documentation</a>.
                                            <?php
} else { ?>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <p>See <a href="" target="_blank">our documentation</a> for further technical details.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="apiTokenModal" role="dialog" data-keyboard="false"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <pre><iframe id="apiTokenIframe" name="apiToken_iframe" src="scripts/eye_spot/php/api_token.php"></iframe></pre>
                                        </div>
                ...
                <div id="teleporter" class="tab-pane fade<?php if ($tab === 'teleporter') { ?> in active<?php } ?>">
                    <div class="row">
                        ...
                        <form role="form" method="post" id="takeoutform"
                            action="scripts/eye_spot/php/teleporter.php"
...
<script src="scripts/eye_spot/js/settings.js?v=<?php echo $cacheVer; ?>"></script>
