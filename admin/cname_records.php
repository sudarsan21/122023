    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-footer clearfix">
                <strong>Note:</strong>
                <p>The target of a <code>CNAME</code> must be a domain that the eye_spot already has in its cache or is authoritative for. This is a universal limitation of <code>CNAME</code> records.</p>
                <p>The reason for this is that eye_spot will not send additional queries upstream when serving <code>CNAME</code> replies. As consequence, if you set a target that isn't already known, the reply to the client may be incomplete. eye_spot just returns the information it knows at the time of the query. This results in certain limitations for <code>CNAME</code> targets,
...
<script src="scripts/eye_spot/js/customcname.js?v=<?php echo $cacheVer; ?>"></script>
