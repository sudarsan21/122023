                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Note that client recognition by IP addresses (incl. subnet ranges) are preferred over MAC address, host name or interface recognition as
                            ...
                            Furthermore, MAC address recognition only works for devices at most one networking hop away from your eye_spot.
                        </p>
                    </div>
                </div>
            </div>
...
<script src="scripts/eye_spot/js/groups-clients.js?v=<?php echo $cacheVer; ?>"></script>
